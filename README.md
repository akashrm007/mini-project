# mini-project
The project involved designing a Ticket vending machine that could dispense ticket for four different routes with varying prices and has the additional feature of returning  when adifference amount when higher denomination coin was inserted. The vending machine only accepts coins of denominations five and ten.
